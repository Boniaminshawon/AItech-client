...
const Services = () => {
    ...
    return (
        <div className="bg-[#f7f9fe] font-primary pt-16">
            <p className="text-[#2d4a8a] text-center text-xl mb-1">We Make Connections</p>
            ...
            <div className="grid grid-cols-4 mt-8">
                {
                services.map(service=><div key={service.service_name} className="p-7 bg-[#FFFFFF] border  border-dotted hover:bg-[#2d4a8a] hover:text-[#ffffff] hover:border-white  mb-6">
