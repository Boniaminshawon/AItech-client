...
const ContactUs = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (email === "" || !/\S+@\S+\.\S+/.test(email)) {
            ...
            toast.success(`Thank you for massaging us`);
                ...
                <div className="col-span-3 bg-[#f7f9fe] md:p-12 p-4">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="w-full space-y-2 mt-6">
                            ...
                            <br />
                            <textarea name="massage" placeholder="Write your massage" className="textarea textarea-bordered textarea-lg w-full " ></textarea>
                        </div>
