...
const SignIn = () => {
    ...
    return (
        <div
            style={{ backgroundImage: 'url("https://i.ibb.co/V91Nj72/col-bgimage-1.jpg")' }}
            className="bg-opacity-100 flex justify-center bg-no-repeat bg-center bg-cover ">


            <div className=" w-full lg:min-h-screen mt-[80px] g-base-200">

                <div className="hero-content flex-col ">

                    <div className="card shrink-0 p-0 w-full lg:w-[490px] shadow-2xl opacity-75 bg-base-100 ">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <input type="submit" className="] text-[#f3a648] font-secondary text-2xl font-bold btn hover:bg-[#235259] bg-[#2d4a8a] " value="Login" />
                            </div>
                        </form>
                        <div className="pl-8 pb-7 font-primary font-medium text-lg text-center md:text-2xl">
                            <p>Don't have account? Please <Link className="underline text-[#2d4a8a] font-semibold text-xl md:text-2xl" to={'/signUp'}>Register</Link></p>
                        </div>
